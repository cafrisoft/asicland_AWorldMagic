...
namespace
{
    const static QMap<QString, FPGA::FPGAType> types =
    {
        { QStringLiteral("FPGA:tcl"), FPGA::TCL },
        { QStringLiteral("FPGA:xdc"), FPGA::XDC },
        { QStringLiteral("invalid"), FPGA::INVALID },
        { QStringLiteral("FPGA:bit"), FPGA::BIT }
