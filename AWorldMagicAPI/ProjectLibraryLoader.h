...
#ifndef PROJECTLIBRARYLOADER_H
#define PROJECTLIBRARYLOADER_H
...
public:
	...
	*/
    explicit ProjectLibraryLoader(MessageMediator* messageChannel);

	//! The destructor.
     ~ProjectLibraryLoader() = default;
...
Q_DECLARE_TYPEINFO(ProjectLibraryLoader::LoadTarget, Q_MOVABLE_TYPE);

#endif // PROJECTLIBRARYLOADER_H
