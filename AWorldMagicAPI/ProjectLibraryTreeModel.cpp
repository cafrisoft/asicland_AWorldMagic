 ...
 *      Author: P.H.G
 *      Filename: ProjectLibraryTreeModel.cpp
 *      Project: AWM
 *      Description :
...
#include "ProjectLibraryTreeModel.h"

//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::ProjectLibraryTreeModel()
//-----------------------------------------------------------------------------
ProjectLibraryTreeModel::ProjectLibraryTreeModel(LibraryInterface* handler, QObject* parent):
...
// Function: ProjectLibraryTreeModel::~ProjectLibraryTreeModel()
//-----------------------------------------------------------------------------
ProjectLibraryTreeModel::~ProjectLibraryTreeModel()
{
    delete rootItem_;
}

//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::headerData()
//-----------------------------------------------------------------------------
QVariant ProjectLibraryTreeModel::headerData(int section, Qt::Orientation orientation, int role) const
{
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::columnCount()
//-----------------------------------------------------------------------------
int ProjectLibraryTreeModel::columnCount(QModelIndex const&) const
{
    return 1;
}

//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::rowCount()
//-----------------------------------------------------------------------------
int ProjectLibraryTreeModel::rowCount(QModelIndex const& parent) const
{
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::index()
//-----------------------------------------------------------------------------
QModelIndex ProjectLibraryTreeModel::index(int row, int column, QModelIndex const& parent) const
{
...
// Function: ProjectLibraryTreeModel::index()
//-----------------------------------------------------------------------------
QModelIndex ProjectLibraryTreeModel::index(LibraryItem* item)
{
    // if pointer is null
    if (!item)
    {
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::parent()
//-----------------------------------------------------------------------------
QModelIndex ProjectLibraryTreeModel::parent(QModelIndex const& child) const
{
    if(!child.isValid())
    {
        return QModelIndex();
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::data()
//-----------------------------------------------------------------------------
QVariant ProjectLibraryTreeModel::data(QModelIndex const& index, int role) const
{
    if (!index.isValid())
    {
        return QVariant();
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::flags()
//-----------------------------------------------------------------------------
Qt::ItemFlags ProjectLibraryTreeModel::flags(QModelIndex const& index) const
{
    if (!index.isValid())
    {
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::hasChildren()
//-----------------------------------------------------------------------------
bool ProjectLibraryTreeModel::hasChildren(QModelIndex const& parent) const
{
    // only one column exists
    if (parent.column() > 0)
    {
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onExportItem()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onExportItem(QModelIndex const& index)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onDeleteItem()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onDeleteItem(QModelIndex const& index)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onRemoveVLNV()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onRemoveVLNV(VLNV const& vlnv)
{
    if (!vlnv.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onAddVLNV()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onAddVLNV(VLNV const& vlnv)
{
    if (!vlnv.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::removeLibraryItem()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::removeLibraryItem(LibraryItem* toRemove)
{
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onResetModel()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onResetModel()
{
    beginResetModel();
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onDocumentUpdated()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onDocumentUpdated(VLNV const& vlnv)
{
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::getRoot()
//-----------------------------------------------------------------------------
LibraryItem* ProjectLibraryTreeModel::getRoot() const
{
    return rootItem_;
}

//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onCreateBus()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onCreateBus(QModelIndex const& index)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onCreateAbsDef()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onCreateAbsDef(QModelIndex const& index)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onCreateComDef()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onCreateComDef(QModelIndex const& index)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onCreateApiDef()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onCreateApiDef(QModelIndex const& index)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onOpenDocument()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onOpenDocument(QModelIndex const& index)
{
//    if (vlnv 형식이 맞다면 ) {
...
//    }
//    else if (verilog 형식이람면) {
//        .....
//        emit openVerilog(path);
//    }
}

//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onOpenDesign()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onOpenDesign(QModelIndex const& index, QString const& viewName)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onOpenMemoryDesign()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onOpenMemoryDesign(QModelIndex const& index, QString const& viewName)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onOpenSWDesign()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onOpenSWDesign(QModelIndex const& index)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onOpenSystemDesign()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onOpenSystemDesign(QModelIndex const& index)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onCreateNewComponent()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onCreateNewComponent(QModelIndex const& index)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onCreateNewDesign()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onCreateNewDesign(QModelIndex const& index)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onCreateNewSWDesign()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onCreateNewSWDesign(QModelIndex const& index)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::onCreateNewSystemDesign()
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onCreateNewSystemDesign(QModelIndex const& index)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
void ProjectLibraryTreeModel::onShowErrors(QModelIndex const& index)
{
    if (!index.isValid())
    {
        return;
...
//-----------------------------------------------------------------------------
// Function: ProjectLibraryTreeModel::validate()
//-----------------------------------------------------------------------------
bool ProjectLibraryTreeModel::validate(LibraryItem* item)
{
    bool isValid = false;
