 ...
 *      Author: P.H.G
 *      Filename: ProjectLibraryTreeModel.h
 *      Project: AWM
 *      Description :
 *          The model that contains the LibraryItems to display library hierarchically.
 */

#ifndef PROJECTLIBRARYTREEMODEL_H
#define PROJECTLIBRARYTREEMODEL_H
...
//! The model that contains the LibraryItems to display library hierarchically.
//-----------------------------------------------------------------------------
//class KACTUS2_API ProjectLibraryTreeModel : public QAbstractItemModel
class ProjectLibraryTreeModel : public QAbstractItemModel
{
    Q_OBJECT
...
public:
	...
	*
	*/
    ProjectLibraryTreeModel(LibraryInterface* handler, QObject* parent = 0);

	//! The destructor
    virtual ~ProjectLibraryTreeModel();
...
//    void exportLibraryItems(const QString& name);
...
private:
    //! No copying
    ProjectLibraryTreeModel(const ProjectLibraryTreeModel& other);

    //! No assignment
    ProjectLibraryTreeModel& operator=(const ProjectLibraryTreeModel& other);
...
#endif // PROJECTLIBRARYTREEMODEL_H
