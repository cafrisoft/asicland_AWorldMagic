...
IOXmlGen::IOXmlGen(): BaseXMLMgr()
{
    LoadScriptPath("");
}

void IOXmlGen::LoadGenXmlInfo(QString xmlFile, QString &vendor, QString &name, QString &version, QString &description, QString& author)
{
    QDomDocument doc;
