...
CreateIpFileSet::CreateIpFileSet(QWidget *parent, CreateIpGeneral* ipGen)
    : QWidget{parent}
{
    _ipGen = ipGen;
    ...
    QLabel *label2 = new QLabel("File Set information of I/O", this);
    QFont font2;
    ...
    /*FolderManager */includeListCtrl = new FolderManager(this);
    ...
    // IncludeListCtrl with checkboxes
    filestCtrl = new FolderManager(this, true);
    filestCtrl->setObjectName("FilesListCtrl");
    mainLayout->addWidget(filestCtrl);


    connect(includeAdd, &QPushButton::clicked, this, &CreateIpFileSet::onIncludeAddClicked);
    connect(fileAdd, &QPushButton::clicked, this, &CreateIpFileSet::onFileAddClicked);
...
void CreateIpFileSet::onIncludeAddClicked() {
...
void CreateIpFileSet::onFileAddClicked() {
