...
class FolderManager : public QWidget {
    Q_OBJECT

public:
    FolderManager(QWidget* parent = nullptr, bool IsFileCtrl=false)
        : QWidget(parent) {
        ...
        connect(folderTree, &QTreeWidget::itemChanged, this, &FolderManager::onItemChanged);
        //항목클릭시
        connect(folderTree, &QTreeWidget::itemClicked, this, &FolderManager::onItemClicked);
...
public:
    FolderManager(QWidget* parent = nullptr)
        : QWidget(parent) {

        layout = new QVBoxLayout(this);
        folderList = new QListWidget(this);
        connect(folderList, &QListWidget::itemChanged, this, &FolderManager::onItemChanged);
