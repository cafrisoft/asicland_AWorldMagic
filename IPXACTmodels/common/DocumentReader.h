...
class DocumentReader : public CommonItemsReader
{    
public:
...
protected:
    ...
    /*!
     *  Parses the author from XML to a document.
     *
     *      @param [in] documentNode    The XML author of the document.
     *      @param [in] document        The document in which the parsed author is inserted.
     */
//    void parseAuthor(QDomNode const& documentNode, QSharedPointer<Document> document) const;
