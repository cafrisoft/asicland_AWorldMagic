...
//-----------------------------------------------------------------------------
// Function: DocumentWriter::writeAuthor()
//-----------------------------------------------------------------------------
//void DocumentWriter::writeAuthor(QXmlStreamWriter& writer, QSharedPointer<Document> document) const
//{
//    writer.writeStartElement(QStringLiteral("ipxact:vendorExtensions"));

//    if (!document->getAuthor().isEmpty())
//    {
//        writer.writeTextElement(QStringLiteral("kactus2:author"), document->getAuthor());
//    }
