...
protected:
    ...
    /*!
     *  Writes the document author into XML.
     *
     *      @param [in] writer       The used XML writer.
     *      @param [in] document     The document whose author to write.
     */
//    void writeAuthor(QXmlStreamWriter& writer, QSharedPointer<Document> document) const;
