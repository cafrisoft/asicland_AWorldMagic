...
//    IPXACTMODELS_EXPORT InterfaceMode getCompatibleInterfaceMode(General::InterfaceMode mode);
     ...
     */
//    IPXACTMODELS_EXPORT QVector<InterfaceMode> getCompatibleInterfaceModesForActiveInterface(General::InterfaceMode mode);
    QVector<InterfaceMode> getCompatibleInterfaceModesForActiveInterface(General::InterfaceMode mode);
     ...
     */
//    IPXACTMODELS_EXPORT QVector<InterfaceMode> getCompatibleInterfaceModeForHierarchicalInterface(General::InterfaceMode mode);
    QVector<InterfaceMode> getCompatibleInterfaceModeForHierarchicalInterface(General::InterfaceMode mode);
...
//    IPXACTMODELS_EXPORT General::DriverType str2DriverType(QString str, General::DriverType defaultValue);
    General::DriverType str2DriverType(QString str, General::DriverType defaultValue);
...
//    IPXACTMODELS_EXPORT QString getRelativePath(QString from, QString to);
    QString getRelativePath(QString from, QString to);
