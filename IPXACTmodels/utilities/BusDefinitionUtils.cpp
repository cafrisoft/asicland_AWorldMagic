...
QStringList BusDefinitionUtils::getSystemGroups(QSharedPointer<const BusDefinition> bus,
...
QList<QSharedPointer<PortAbstraction> > BusDefinitionUtils::getExtendedLogicalSignals(
