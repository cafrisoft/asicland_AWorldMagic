...
//! ProjectHandler is the class that implements the services to manage the IP-XACT library.
//-----------------------------------------------------------------------------
//class KACTUS2_API ProjectHandler : public QObject, public LibraryInterface
class ProjectHandler : public QObject, public LibraryInterface
{
    Q_OBJECT
...
public:
    ...
    //! No copying
    ProjectHandler(const ProjectHandler &other) = delete;

    //! The destructor
    virtual ~ProjectHandler() = default;

    //! No assignment
    ProjectHandler &operator=(const ProjectHandler &other) = delete;
 ...
 */
    ProjectHandler(MessageMediator* messageChannel, QObject* parent = nullptr);
