...
//! The model that contains the LibraryItems to display library hierarchically.
//-----------------------------------------------------------------------------
//class KACTUS2_API ProjectTreeModel : public QAbstractItemModel
...
public:
	...
	*
	*/
    ProjectTreeModel(LibraryInterface* handler, QObject* parent = 0);
...
//    void exportProjectItems(const QString& name);
...
private:
	...
	//! No assignment
    ProjectTreeModel& operator=(const ProjectTreeModel& other);
