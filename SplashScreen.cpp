...
QSplashScreen(QPixmap(":/resources/Res/splash.png")),
...
void SplashScreen::drawContents(QPainter *painter)
{
    ...
    painter->drawText(QRectF(5, 220, 590, 35), Qt::AlignCenter, tr("Version %1").arg(versionString_));
    ...
    painter->drawText(QRectF(5, 240, 590, 160), Qt::AlignCenter,
        QString::fromLatin1("Copyright 2023 asicland all rignt reserved."));
}
