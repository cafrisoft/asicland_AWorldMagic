...
public:
     ...
     *  Constructor.
     */
    DesignWidget(LibraryInterface* designInterface, LibraryInterface* libraryInterface, QWidget* parent = 0);
	...
	*/
    ...
    void test(QSharedPointer<Component> component, const QString& viewName);
...
protected:
    ...
    /*!
     *  Returns the design interface.
     */
    LibraryInterface* getInterface(const VLNV& vlnv) const;

    /*!
     *  Returns the design interface.
     */
    LibraryInterface* getDesignInterface() const;
