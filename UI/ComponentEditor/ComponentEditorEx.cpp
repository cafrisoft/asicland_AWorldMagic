...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::ComponentEditorEx()
//-----------------------------------------------------------------------------
ComponentEditorEx::ComponentEditorEx(LibraryInterface* designInterface,
...
navigationView_(libInterface, component->getVlnv(), &navigationSplitter_),
proxy_(this),
...
parameterReferenceWindow_()
{
    ...
    setDocumentName( QString("[%3] %1 (%2) ").arg(component_->getVlnv().getName()).arg(
        component_->getVlnv().getVersion()).arg(libHandler_->getType()) );
...
// Function: ComponentEditorEx::~ComponentEditorEx()
//-----------------------------------------------------------------------------
ComponentEditorEx::~ComponentEditorEx()
{

}

//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::getIdentifyingVLNV()
//-----------------------------------------------------------------------------
VLNV ComponentEditorEx::getIdentifyingVLNV() const
{
    return getDocumentVLNV();
}

//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::getDocumentVLNV()
//-----------------------------------------------------------------------------
VLNV ComponentEditorEx::getDocumentVLNV() const
{
	return component_->getVlnv();
}

//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::isHWImplementation()
//-----------------------------------------------------------------------------
bool ComponentEditorEx::isHWImplementation() const
{
    return component_->getImplementation() == KactusAttribute::HW;
}

//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::refresh()
//-----------------------------------------------------------------------------
void ComponentEditorEx::refresh()
{
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::applySettings()
//-----------------------------------------------------------------------------
void ComponentEditorEx::applySettings(QSettings& settings)
{
	setRowVisibility(settings);
}

//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::getHwItemNames()
//-----------------------------------------------------------------------------
QStringList ComponentEditorEx::getHwItemNames()
{
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::getSwItemNames()
//-----------------------------------------------------------------------------
QStringList ComponentEditorEx::getSwItemNames()
{
	QStringList itemNames;
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::validate()
//-----------------------------------------------------------------------------
bool ComponentEditorEx::validate(QVector<QString>& errorList)
{
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::save()
//-----------------------------------------------------------------------------
bool ComponentEditorEx::save()
{
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::saveAs()
//-----------------------------------------------------------------------------
bool ComponentEditorEx::saveAs()
{
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::onNavigationTreeSelection()
//-----------------------------------------------------------------------------
void ComponentEditorEx::onNavigationTreeSelection( const QModelIndex& index )
{
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::onExpand()
//-----------------------------------------------------------------------------
void ComponentEditorEx::onExpand(const QModelIndex& index)
{    
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::onErrorDialog()
//-----------------------------------------------------------------------------
void ComponentEditorEx::onErrorDialog(const QString& message)
{
    QMessageBox::warning(this, tr("Component editor"), message);
}

//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::onItemActivated()
//-----------------------------------------------------------------------------
void ComponentEditorEx::onItemActivated( const QModelIndex& index )
{
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::setProtection()
//-----------------------------------------------------------------------------
void ComponentEditorEx::setProtection( bool locked )
{
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::setRowVisibility()
//-----------------------------------------------------------------------------
void ComponentEditorEx::setRowVisibility(QSettings& settings)
{
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::createNavigationRootForComponent()
//-----------------------------------------------------------------------------
QSharedPointer<ComponentEditorRootItem> ComponentEditorEx::createNavigationRootForComponent(
    QSharedPointer<Component> component)
{
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::setupLayout()
//-----------------------------------------------------------------------------
void ComponentEditorEx::setupLayout()
{
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::updateComponentFiles()
//-----------------------------------------------------------------------------
void ComponentEditorEx::updateComponentFiles(QSharedPointer<Component> targetComponent,
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::getComponentFileNames()
//-----------------------------------------------------------------------------
QStringList ComponentEditorEx::getComponentFileNames(QSharedPointer<Component> component) const
{
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::changeFileName()
//-----------------------------------------------------------------------------
void ComponentEditorEx::changeFileName(QString const& from, QString const& to, QSharedPointer<Component> component)
    const
{
    for (QSharedPointer<FileSet> fileSet : *component->getFileSets())
    {
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::openItemEditor()
//-----------------------------------------------------------------------------
void ComponentEditorEx::openItemEditor(QVector<QString> itemIdentifierChain)
{
...
//-----------------------------------------------------------------------------
// Function: ComponentEditorEx::getComponent()
//-----------------------------------------------------------------------------
QSharedPointer<Component> ComponentEditorEx::getComponent() const
{
    return component_;
}
