...
#include <UI/ComponentEditor/busInterfaces/portmaps/PortMapDelegate.h>
#include <UI/ComponentEditor/busInterfaces/portmaps/PortMapHeaderView.h>
#include <UI/ComponentEditor/busInterfaces/portmaps/PortMapsColumns.h>
...
portMapDelegate_(0),
autoConnectButton_(QIcon(":/resources/Res/connect.png"), "Auto connect all", this),
removeAllMappingsButton_(QIcon(":/resources/Res/delete.png"), "Remove all", this),
...
void BusInterfacePortMapTab::setupLayout()
{
    ...
    QPushButton* addSignalButton(new QPushButton(QIcon(":/resources/Res/add.png"), "Add", this));
