...
#include <KactusAPI/FileHandler.h>
...
void FileDependencyEditor::scan()
{
    ...
    runAnalysisAction_->setIcon(QIcon(":/resources/Res/control-stop.png"));
    scanning_ = true;
...
{
    scanning_ = false;
    runAnalysisAction_->setIcon(QIcon(":/resources/Res/control-play.png"));
...
void FileDependencyEditor::setupToolbar()
{
    ...
    addFilterButton(QIcon(":/resources/Res/traffic-light_green.png"), tr("Show Unchanged Files"),
        FileDependencyGraphView::FILTER_GREEN);
    addFilterButton(QIcon(":/resources/Res/traffic-light_yellow.png"),
        tr("Show Changed Files (Only Contents Changed)"),
        FileDependencyGraphView::FILTER_YELLOW);
    addFilterButton(QIcon(":/resources/Res/traffic-light_red.png"),
        tr("Show Changed Files (Dependencies Changed)"),
        FileDependencyGraphView::FILTER_RED);
    addFilterButton(QIcon(":/resources/Res/dependency_twoway.png"),
        tr("Show Bidirectional Dependencies"),
        FileDependencyGraphView::FILTER_TWO_WAY);
    addFilterButton(QIcon(":/resources/Res/dependency_oneway.png"),
        tr("Show Unidirectional Dependencies"),
        FileDependencyGraphView::FILTER_ONE_WAY);
    addFilterButton(QIcon(":/resources/Res/dependency_manual.png"),
        tr("Show Manual Dependencies"),
        FileDependencyGraphView::FILTER_MANUAL);
    addFilterButton(QIcon(":/resources/Res/dependency_auto.png"),
        tr("Show Analyzed Dependencies"),
        FileDependencyGraphView::FILTER_AUTOMATIC);
    addFilterButton(QIcon(":/resources/Res/external.png"), tr("Show External"),
        FileDependencyGraphView::FILTER_EXTERNAL);
    addFilterButton(QIcon(":/resources/Res/diff.png"), tr("Show Differences"),
    ...
    runAnalysisAction_ = toolbar_.addAction(QIcon(":/resources/Resresources/Res/control-play.png"), tr("Rescan"),
        this, SLOT(scan()));
}
