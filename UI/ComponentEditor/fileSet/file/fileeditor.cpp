...
runButton_(new QPushButton(QIcon(":/resources/Res/script-run-file.png"), tr("Run file"), this)),
openFolderButton_(new QPushButton(QIcon(":/resources/Res/opened-folder.png"),
