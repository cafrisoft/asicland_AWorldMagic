 ...
 *      Author: P.H.G
 *      Filename: ImportSelectionDialog.h
 *      Project: AWM
 *      Description :
...
public:
	 ...
	 */
    ImportSelectionDialog(QString const& okButtonText, QString const& iconPath, QString const& okIconPath,
        QString const& windowTitle, QWidget* parent = 0, Qt::WindowFlags f = Qt::WindowFlags());

    /*!
	 *  The destructor.
	 */
    virtual ~ImportSelectionDialog();
...
//    void createItem(const QString& path, const VLNV& vlnv = VLNV(), bool locked = false);
     ...
     */
//    QVector<ImportSelectionListItem*> getSelectedItems() const;
...
private:
    ...
    ImportSelectionDialog(const ImportSelectionDialog& other);
    ImportSelectionDialog& operator=(const ImportSelectionDialog& other);
