...
//#include <UI/Widgets/LibrarySelectorWidget/LibrarySelectorWidget.h>

#include <UI/Widgets/LineEditEx/LineEditEx.h>
...
QDialog(parent), 
      ...
      directoryEditor_(new ProjectSelectorWidget(this)),
      ...
      designConfExt_()
{
    ...
    if (designType == KactusAttribute::HW)
    {
        ...
        designIcon_->setPixmap(QPixmap(":/resources/Res/hw-design.png"));
    }
    else if (designType == KactusAttribute::SW)
    {
        ...
        designIcon_->setPixmap(QPixmap(":/resources/Res/sw-design48x48.png"));
    }
    ...
    viewNameEdit_->setMessageIcon(QPixmap(":/resources/Res/exclamation.png"));
