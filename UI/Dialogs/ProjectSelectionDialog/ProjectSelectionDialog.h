 ...
 *      Author: P.H.G
 *      Filename: ProjectSelectionDialog.h
 *      Project: AWM
 *      Description :
...
class ProjectSelectionListItem;
...
public:
	 ...
	 */
    ProjectSelectionDialog(QString const& okButtonText, QString const& iconPath, QString const& okIconPath,
...
//    void createItem(const QString& path, const VLNV& vlnv = VLNV(), bool locked = false);
     ...
     */
//    QVector<ProjectSelectionListItem*> getSelectedItems() const;
...
private:
    ...
    ProjectSelectionDialog(const ProjectSelectionDialog& other);
    ProjectSelectionDialog& operator=(const ProjectSelectionDialog& other);
