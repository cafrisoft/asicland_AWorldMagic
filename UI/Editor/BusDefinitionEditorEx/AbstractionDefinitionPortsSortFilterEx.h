//-----------------------------------------------------------------------------
// File: AbstractionDefinitionPortsSortFilterEx.h
//-----------------------------------------------------------------------------
// Project: AWM
// Author: P.H.G
// Date: 19.06.2024
...
#ifndef ABSTRACTIONDEFINITIONPORTSSORTFILTEREX_H
#define ABSTRACTIONDEFINITIONPORTSSORTFILTEREX_H
...
//! Sort filter proxy model for abstraction definition ports.
//-----------------------------------------------------------------------------
class AbstractionDefinitionPortsSortFilterEx : public QSortFilterProxyModel
{
...
public:
	 ...
	 */
    AbstractionDefinitionPortsSortFilterEx(
        PortAbstractionInterface* portInterface, QObject *parent);

	/*!
	 *  The destructor.
	 */
    virtual ~AbstractionDefinitionPortsSortFilterEx() = default;
...
private:
    ...
    AbstractionDefinitionPortsSortFilterEx(const AbstractionDefinitionPortsSortFilterEx& other);
    AbstractionDefinitionPortsSortFilterEx& operator=(const AbstractionDefinitionPortsSortFilterEx& other);
...
#endif // ABSTRACTIONDEFINITIONPORTSSORTFILTEREX_H
