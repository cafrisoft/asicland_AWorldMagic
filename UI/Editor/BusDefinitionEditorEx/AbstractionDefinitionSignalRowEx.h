//-----------------------------------------------------------------------------
// File: AbstractionDefinitionSignalRowEx.h
//-----------------------------------------------------------------------------
// Project: AWM
// Author: P.H.G
// Date: 19.06.2024
...
#ifndef ABSTRACTIONDEFINITIONSIGNALROWEX_H
#define ABSTRACTIONDEFINITIONSIGNALROWEX_H
...
//! Represents a row in the abstraction ports table by grouping the Port, Wire and Transactional elements.
//-----------------------------------------------------------------------------
class AbstractionDefinitionSignalRowEx
{
public:
     ...
     *  The constructor.
     */
    AbstractionDefinitionSignalRowEx();

    /*!
     *  The destructor.
     */
    virtual ~AbstractionDefinitionSignalRowEx() = default;

    /*!
     *  Copy constructor
     */
    AbstractionDefinitionSignalRowEx(AbstractionDefinitionSignalRowEx const& other) = default;
     ...
     */
    bool operator==(AbstractionDefinitionSignalRowEx const& other) const;
     ...
     */
    bool comparedSignalIsSameType(AbstractionDefinitionSignalRowEx const& comparisonSignal) const;
...
#endif // ABSTRACTIONDEFINITIONSIGNALROWEX_H
