//-----------------------------------------------------------------------------
// File: AbstractionPortsModelEx.h
//-----------------------------------------------------------------------------
// Project: AWM
// Author: P.H.G
// Date: 19.06.20246
...
#ifndef ABSTRACTIONPORTSMODELEX_H
#define ABSTRACTIONPORTSMODELEX_H
...
//! Data model for the signals within abstraction definition.
//-----------------------------------------------------------------------------
class AbstractionPortsModelEx : public QAbstractTableModel
{
	Q_OBJECT
...
public:
	 ...
	 */
    AbstractionPortsModelEx(LibraryInterface* libraryAccess, PortAbstractionInterface* portInterface,
	 ...
	 *  The destructor.
	 */
    virtual ~AbstractionPortsModelEx() = default;

    //! No copying. No assignment.
    AbstractionPortsModelEx(const AbstractionPortsModelEx& other) = delete;
    AbstractionPortsModelEx& operator=(const AbstractionPortsModelEx& other) = delete;
...
private:
    ...
    QList<AbstractionDefinitionSignalRowEx> table_;
...
#endif // ABSTRACTIONPORTSMODELEX_H
