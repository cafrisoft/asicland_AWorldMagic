...
#ifndef BUSDEFGROUPEX_H
#define BUSDEFGROUPEX_H
...
#include <UI/Widgets/listManager/listmanager.h>

//#include <UI/BusDefinitionEditor/SystemGroupListEditor.h>
...
//! BusDefGroupEx contains elements to set the properties of a Bus Definition.
//-----------------------------------------------------------------------------
class BusDefGroupEx : public QWidget
{
	Q_OBJECT
...
public:
	 ...
	 */
    BusDefGroupEx(LibraryInterface* libraryHandler, QWidget *parent);

    /*!
     *  The destructor.
     */
    virtual ~BusDefGroupEx() = default;
...
//    void onSystemNamesChanged();
    ...
    /*!
     *  Handler for changes in author line edit.
     */
...
private:
    ...
    BusDefGroupEx(const BusDefGroupEx& other);
    BusDefGroupEx& operator=(const BusDefGroupEx& other);
