//-----------------------------------------------------------------------------
// File: ComponentEditorByProject.h
//-----------------------------------------------------------------------------
// Project: AWM
// Author: P.H.G
// Date: 17.07.2024
...
#ifndef COMPONENTEDITORBYPROJECT_H
#define COMPONENTEDITORBYPROJECT_H
...
//! The editor to edit/packet IP-Xact components.
//-----------------------------------------------------------------------------
class ComponentEditorByProject : public TabDocument
{
	Q_OBJECT
...
public:
	 ...
	 *
	 */
    ComponentEditorByProject(LibraryInterface* designInterface,
                             LibraryInterface* libHandler,
                             QSharedPointer<Component> component,
                             QWidget *parent);

	//! The destructor
    ~ComponentEditorByProject();
...
private slots:
	...
	*/
     ...
     * calls ComponentEditorByProject::onItemActivated() slot.
	 * 
...
private:
	...
	//! No copying
    ComponentEditorByProject(const ComponentEditorByProject& other);

	//! No assignment
    ComponentEditorByProject& operator=(const ComponentEditorByProject& other);
...
#endif // COMPONENTEDITORBYPROJECT_H
