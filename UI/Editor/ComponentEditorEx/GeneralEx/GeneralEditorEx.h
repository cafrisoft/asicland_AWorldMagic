...
#ifndef GENERALEDITOREX_H
#define GENERALEDITOREX_H
...
//-----------------------------------------------------------------------------
//! GeneralEditorEx class.
//-----------------------------------------------------------------------------
class GeneralEditorEx : public ItemEditor
{
    Q_OBJECT
...
public:
	 ...
	 */
    GeneralEditorEx(LibraryInterface* libHandler, QSharedPointer<Component> component, QWidget *parent = 0);

    /*!
     *  Destructor.
     */
    ~GeneralEditorEx() final = default;
...
private:
    ...
    // Disable copying.
    GeneralEditorEx(const GeneralEditorEx& other);
    GeneralEditorEx& operator=(const GeneralEditorEx& other);
