...
#ifndef ITEMEDITOREX_H
#define ITEMEDITOREX_H
...
//-----------------------------------------------------------------------------
class ItemEditorEx : public QWidget
{
    Q_OBJECT
...
public:
     ...
     */
    ItemEditorEx(QSharedPointer<Component> component, LibraryInterface* handler, QWidget *parent = 0);

    //! The destructor.
    virtual ~ItemEditorEx();
...
signals:
    ...
    void inputMessage(const QString& msg) const;
...
private:
    ...
    ItemEditorEx(const ItemEditorEx& other);
    ItemEditorEx& operator=(const ItemEditorEx& other);
