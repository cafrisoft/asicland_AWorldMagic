...
#include <UI/Common/layouts/VCollisionLayout.h>
...
#include <UI/HWDesign/undoCommands/ComponentItemMoveCommand.h>
...
HWComponentItem::HWComponentItem(
    ...
    ComponentItem(QRectF(), designInterface, libInterface, instance, component, parent),
...
void HWComponentItem::updateComponent()
{
    ...
    else if (getDesignInterface()->contains(componentModel()->getVlnv()))
    {
