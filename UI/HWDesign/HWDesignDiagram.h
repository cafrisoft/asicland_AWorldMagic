...
#include <UI/Common/ComponentDesignDiagram.h>
...
public:
     ...
     */
    HWDesignDiagram(LibraryInterface *designInterface,
...
protected:
     ...
     */
    void setInterfaceVLNVatEndpoint(LibraryInterface* libraryInterface, VLNV const& droppedVLNV);
