...
signals:
    ...
    void changeDesignProtection(bool const &locked);
...
public slots:
    ...
    //! Create new I/O
    void onCreateBusAction();

    //! Create new IP
    void onCreateHWComponentAction();
...
private:
    ...
    //! Create new I/O for a component.
    QAction* createBusAction_;

    //! Create new IP for a component.
    QAction* createHWComponetAction_;
