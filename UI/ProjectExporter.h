...
#include <UI/Dialogs/ProjectSelectionDialog/ProjectSelectionListItem.h>
...
public:
     ...
     */
    ProjectExporter(LibraryInterface* libraryAccess,
    ...
    ProjectExporter(const ProjectExporter &other) = delete;
    ProjectExporter &operator=(const ProjectExporter &other) = delete;
...
public slots:
     ...
     */
    void onExportItems(const QString& name, const QList<VLNV> vlnvs);
...
private:
    ...
    void compressFiles(const QStringList &inputFileNames, const QString &outputFileName);
     ...
     */
//    DocumentStatistics exportSelectedObjects(QVector<ProjectSelectionListItem*> const& exportedItems,
//        QString const& destinationPath, const QString& sourcePath);
    DocumentStatistics exportSelectedObjects(QString const& destinationPath, const QString& sourcePath, const QString& filename);
     ...
     */
    QVector<ProjectSelectionListItem const*> getExportedFilesForComponent(int const& componentIndex,
     ...
     */
    bool copyFile(ProjectSelectionListItem::ItemType itemType, QFileInfo const& source, VLNV const& containingVLNV,
