...
//-----------------------------------------------------------------------------
// Function: ProjectItemSelectionFactory::constructItemsForSelectionDialog()
//-----------------------------------------------------------------------------
//void ProjectItemSelectionFactory::constructItemsForSelectionDialog(LibraryInterface* library,
//    ProjectSelectionDialog* dialog, QList<VLNV> const& vlvns)
//{
...
//-----------------------------------------------------------------------------
// Function: ProjectItemSelectionFactory::addComponentFilesAndDesignItems()
//-----------------------------------------------------------------------------
//void ProjectItemSelectionFactory::Details::addComponentFilesAndDesignItems(LibraryInterface* library,
...
//-----------------------------------------------------------------------------
// Function: ProjectItemSelectionFactory::addDesignItemForConfiguration()
//-----------------------------------------------------------------------------
//void ProjectItemSelectionFactory::Details::addDesignItemForConfiguration(LibraryInterface* library,
//    ProjectSelectionDialog* dialog, VLNV const& configurationVLNV)
//{
//    VLNV designVLNV =
...
//-----------------------------------------------------------------------------
// Function: ProjectItemSelectionFactory::addAbstractionDefinitionItems()
//-----------------------------------------------------------------------------
//void ProjectItemSelectionFactory::Details::addAbstractionDefinitionItems(LibraryInterface* library,
//    ProjectSelectionDialog* dialog, VLNV const& busDefinitionVLNV)
//{
...
//-----------------------------------------------------------------------------
// Function: ProjectItemSelectionFactory::addBusDefintionItemIfOnlyAbstraction()
//-----------------------------------------------------------------------------
//void ProjectItemSelectionFactory::Details::addBusDefintionItemIfOnlyAbstraction(LibraryInterface* library,
//    ProjectSelectionDialog* dialog, VLNV const& abstractionVLNV)
//{
//    VLNV busVLNV =
