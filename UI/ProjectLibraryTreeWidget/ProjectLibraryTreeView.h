...
#ifndef PROJECTLIBRARYTREEVIEW_H
#define PROJECTLIBRARYTREEVIEW_H
...
//! The widget to display the library in a tree.
//-----------------------------------------------------------------------------
class ProjectLibraryTreeView : public ExpandingTreeView
{
	Q_OBJECT
...
public:
	...
	*
	*/
    ProjectLibraryTreeView(LibraryInterface* handler,
                           ProjectLibraryTreeFilter* filter,
                           QWidget* parent = 0);

	//! The destructor.
    virtual ~ProjectLibraryTreeView() = default;
...
private:
    ...
    //! No assignment
    ProjectLibraryTreeView(const ProjectLibraryTreeView& other);

	//! No copying
    ProjectLibraryTreeView& operator=(const ProjectLibraryTreeView& other);
...
//    QAction* exportAction_;
    ...
    QAction* openXmlAction_;ion(tr("Open XML File"), this)),
#endif
...
#endif // PROJECTLIBRARYTREEVIEW_H
