...
//-----------------------------------------------------------------------------
// Function: ProjectTreeFilter::ProjectTreeFilter()
//-----------------------------------------------------------------------------
ProjectTreeFilter::ProjectTreeFilter(LibraryInterface* handler, QObject *parent):
...
//-----------------------------------------------------------------------------
// Function: ProjectTreeFilter::filterAcceptsRow()
//-----------------------------------------------------------------------------
bool ProjectTreeFilter::filterAcceptsRow(int sourceRow, const QModelIndex& sourceParent) const
{
