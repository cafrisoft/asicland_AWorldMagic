...
#include <UI/Settings/PluginInfoWidget.h>
#include <UI/Settings/NewPluginsDialog.h>
    ...
    directoriesChanged_(false)
{
    ...
    QString stylesheet("QTreeView#PluginsTree::indicator:unchecked {image: url(:resources/Res/traffic-light_gray.png);}"
        "QTreeView#PluginsTree::indicator:checked {image: url(:resources/Res/traffic-light_green.png);}");
