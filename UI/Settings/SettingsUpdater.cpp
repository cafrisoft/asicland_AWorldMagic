...
#include <UI/Widgets/assistedTextEdit/HighlightStyleDesc.h>
...
//    if (!isVersionOlderThan(settingsVersion, VersionHelper::versionFull()))
    {
        // Already up-to-date.
        return;
    }
...
//    QFile* configurationFile = openConfigurationFile(mediator);
...
//        else if (isVersionOlderThan(settingsVersion, versionIterator))
        {
...
//bool SettingsUpdater::isVersionOlderThan(QString const& version, QString const& comparison)
{
...
//QFile* SettingsUpdater::openConfigurationFile(MessageMediator* mediator)
{        
...
//QVariant SettingsUpdater::parseVariant(QTextStream& lineStream)
{
