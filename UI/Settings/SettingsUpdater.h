...
{
//public:
//    static SettingsUpdater& getInstance()
//    {
//        static SettingsUpdater instance; // Guaranteed to be destroyed, instantiated on first use.
//        return instance;
//    }

//private:
//    SettingsUpdater() {} // Prevent construction
//    ~SettingsUpdater() {} // Prevent unwanted destruction

////    SettingsUpdater() = default;
