...
#include <UI/Common/layouts/VStackedLayout.h>
...
//-----------------------------------------------------------------------------
HWMappingItem::HWMappingItem(LibraryInterface* designInterface,
                             LibraryInterface* libInterface,
                             QSharedPointer<Component> component,
                             QSharedPointer<ComponentInstance> instance):
    SystemComponentItem(QRectF(-WIDTH/ 2, 0, WIDTH, 0), designInterface, libInterface, instance, component, 0),
    oldStack_(0),
