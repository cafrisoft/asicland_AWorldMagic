...
#include <UI/SystemDesign/UndoCommands/SWPortDeleteCommand.h>
#include <UI/SystemDesign/UndoCommands/SWInterfaceDeleteCommand.h>
...
//-----------------------------------------------------------------------------
SystemDesignWidget::SystemDesignWidget(bool onlySW,
    ...
    onlySW_(onlySW)
{
    ...
    setDiagram(new SystemDesignDiagram(onlySW, designInterface, libraryInterface, getEditProvider(), this));
}
