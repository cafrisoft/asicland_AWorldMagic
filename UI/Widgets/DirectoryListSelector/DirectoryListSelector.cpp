...
QWidget(parent),
    buttonAdd_(new QPushButton(QIcon(":/resources/Res/opened-folder.png"), QString(), this)),
    buttonRemove_(new QPushButton(QIcon(":/resources/Res/remove.png"), QString(), this)),
