...
#include <UI/Widgets/EnumCollectionEditor/EnumCollectionEditor.h>
...
void EnumerationEditor::setupLayout()
{
    ...
    okButton->setIcon(QIcon(":/resources/Res/checkMark.png"));
    okButton->setToolTip("Accept");

    QPushButton* cancelButton = new QPushButton();
    cancelButton->setIcon(QIcon(":/resources/Res/grey_cross.png"));
