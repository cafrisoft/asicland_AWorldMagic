...
public:
	...
	enum SupportedWindows {
        ...
        REPORTWINDOW            = 0x004,
        LIBRARYWINDOW           = 0x008,
        CONFIGURATIONWINDOW     = 0x010,
        CONNECTIONWINDOW        = 0x020,
        INTERFACEWINDOW         = 0x040,
        INSTANCEWINDOW          = 0x080,
        SYSTEM_DETAILS_WINDOW   = 0x100,
        CONTEXT_HELP_WINDOW     = 0x200,
        ADHOC_WINDOW            = 0x800,
        DESIGNPARAMETERSWINDOW  = 0x1000,
        VENDOREXTENSIONWINDOW   = 0x2000,
        TEXTEDITORWINDOW        = 0x4000,
        WELCOMEWINDOW           = 0x8000
	};

    enum WhatWindowIsThis {
        IO,
        COMPONENT,
        DESIGN,
        SCHEMATIC,
    ...
    virtual unsigned int getWhatWindowIsThis() const;
...
protected:
    ...
    unsigned int whatWindowIsThis_;
