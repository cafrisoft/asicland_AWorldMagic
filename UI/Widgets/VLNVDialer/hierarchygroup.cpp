...
flatBox_(QIcon(":resources/Res/square.png"), QString(), this),
productBox_(QIcon(":resources/Res/box.png"), QString(), this),
boardBox_(QIcon(":resources/Res/circuit.png"), QString(), this),
chipBox_(QIcon(":resources/Res/chip.png"), QString(), this),
socBox_(QIcon(":resources/Res/soc.png"), QString(), this),
ipBox_(QIcon(":resources/Res/capacitor.png"), QString(), this),
options_()
{
