...
ImplementationGroup::ImplementationGroup(QWidget* parent) :
    ...
    hwBox_(QIcon(":resources/Res/transistor.png"), QString(), this),
    swBox_(QIcon(":resources/Res/sw-component48x48.png"), QString(), this),
    systemBox_(QIcon(":resources/Res/system-component.png"), QString(), this),
    options_()
{
