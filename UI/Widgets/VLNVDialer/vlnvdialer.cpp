...
#include <UI/Widgets/tagEditor/TagSelectorContainer.h>
...
VLNVDialer::VLNVDialer(QWidget *parent):
    QWidget(parent),
    hideButton_(QIcon(":/resources/Res/filter.png"), QString(), this),
    selectAllButton_(QIcon(":/resources/Res/check-all.png"), QString(), this),
    filters_(this),
    dialer_(this),
...
void VLNVDialer::onSelectAll()
{
    ...
    if (allSelected_)
    {
        ...
        selectAllButton_.setIcon(QIcon(":/resources/Res/uncheck-all.png"));
    }
    else
    {
        selectAllButton_.setToolTip("Select all");
        selectAllButton_.setIcon(QIcon(":/resources/Res/check-all.png"));
    }
