...
public:
     ...
     *      @param [in] component  The component to visualize.
     */
    void setComponent(LibraryInterface* lh, QSharedPointer<Component> component);
     ...
     *  Updates the preview.
     */
    void updatePreview(LibraryInterface* lh);
...
public slots:
     ...
     *		to component then the preview box is cleared.
     */
    void setComponent(LibraryInterface* lh, const VLNV& vlnv);
