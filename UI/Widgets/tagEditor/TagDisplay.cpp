...
#include <UI/Widgets/colorBox/ColorBox.h>

#include <UI/Widgets/tagEditor/TagLabel.h>
#include <UI/Widgets/tagEditor/TagCompleterModel.h>
...
QFrame(parent),
colorButton_(),
deleteButton_(new QPushButton(QIcon(":/resources/Res/cross.png"), QLatin1String(""), this)),
