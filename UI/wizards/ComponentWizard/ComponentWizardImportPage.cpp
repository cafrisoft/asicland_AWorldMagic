...
#include <UI/wizards/ComponentWizard/ImportEditor.h>
...
ComponentWizardImportPage::ComponentWizardImportPage(QSharedPointer<Component> component,
                                                     ...
                                                     QWidget* parent):
QWizardPage(parent),
editor_(new ImportEditor(component, designInterface, libraryInterface, parameterFinder, expressionFormatter, busInterface, this))
{
