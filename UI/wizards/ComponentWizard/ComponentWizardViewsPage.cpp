...
#include <UI/ComponentEditor/views/vieweditor.h>
...
addButton_(new QPushButton(QIcon(":/resources/Res/add.png"), QString(), this)),
removeButton_(new QPushButton(QIcon(":/resources/Res/remove.png"), QString(), this)),
...
void ComponentWizardViewsPage::updateIconForTab(int tabIndex) const
{
    ...
    {
        editorTabs_->setTabIcon(tabIndex, QIcon(":resources/Res/exclamation.png"));
    }
}
