...
public:
     ...
     *      @param [in] designInterface	    Pointer to the instance which manages the design.
     *      @param [in] libraryInterface	    Pointer to the instance which manages the library.
...
private slots:
    ...
    void onFileSelected(QString const& filePath, QString const& absolutePath, QSharedPointer<FileSet> fileSet);
...
private:
    ...
    QString selectedSourceAbsolutePath_;
