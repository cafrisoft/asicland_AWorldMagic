...
#include <UI/wizards/common/ComponentComparator/ComponentComparator.h>
...
void ComponentDiffWidget::addAddItem(QString const& name, QTreeWidgetItem* parent)
{
    ...
    addItem->setIcon(ITEM_NAME, QIcon(":/resources/Res/add.png"));
}
...
void ComponentDiffWidget::addRemoveItem(QString const& name, QTreeWidgetItem* parent)
{
    ...
    removeItem->setIcon(ITEM_NAME, QIcon(":/resources/Res/remove.png"));
}
    ...
    IPXactDiff::Modification const& modification, QTreeWidgetItem* parent)
{
    ...
    modificationItem->setIcon(ITEM_NAME, QIcon(":/resources/Res/star.png"));
}
    ...
    QList<IPXactDiff::Modification> changelist, QTreeWidgetItem* parent)
{
    ...
    child->setIcon(ITEM_NAME, QIcon(":/resources/Res/star.png"));
